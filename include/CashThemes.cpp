...
void FThemeColor_DefaultLight()
{
    ImGui::StyleColorsLight();
}

void FThemeColor_DefaultClassic()
{
    ImGui::StyleColorsClassic();
}

void FThemeColor_DefaultDark()
{
    ImGui::StyleColorsDark();
}

void FThemeColor_GreenAccent()
{
...
void FThemeColor_Quantum()
{
    //ImVec4(0.11f, 0.15f, 0.26f, 1.00f);  Quantum Logo Color
    ImVec4* colors = ImGui::GetStyle().Colors;
    colors[ImGuiCol_Text]                   = ImVec4(1.00f, 1.00f, 1.00f, 1.00f);
    colors[ImGuiCol_TextDisabled]           = ImVec4(0.50f, 0.50f, 0.50f, 1.00f);
#if 0
    ...
    //colors[ImGuiCol_DockingPreview]       = ImVec4(0.26f, 0.59f, 0.98f, 0.70f);
    //colors[ImGuiCol_DockingEmptyBg]       = ImVec4(0.20f, 0.20f, 0.20f, 1.00f);
    colors[ImGuiCol_PlotLines]              = ImVec4(0.00f, 0.67f, 0.88f, 1.00f);
    colors[ImGuiCol_PlotLinesHovered]       = ImVec4(0.10f, 1.00f, 1.00f, 1.00f);
...
void FThemeStyle_SimpleRounding()
{
    ImGuiStyle& style = ImGui::GetStyle();
...
g_ ## __type ## Options[__type ## _ ## __name].name       = #__name; \
g_ ## __type ## Options[__type ## _ ## __name].function   = F ## __type ## _ ## __name
...
{
    FThemeColor_DefaultDark();
    g_ThemeColorOptions[color].function();
}

void ThemeSetStyle(i32 style)
{
    FThemeStyle_Original();
    g_ThemeStyleOptions[style].function();
}
